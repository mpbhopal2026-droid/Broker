...
export function buildCsp(nonce: string): string {
  ...
  return [
    ...
    `connect-src 'self' https://*.supabase.co wss://*.supabase.co https://*.googleapis.com https://*.firebaseio.com https://api.resend.com https://cloudflareinsights.com https://*.cloudflareinsights.com https://static.cloudflareinsights.com https://*.tradingview.com https://*.tradingview-widget.com`,
    `frame-src 'self' https://s.tradingview.com https://www.tradingview.com https://*.tradingview.com https://www.tradingview-widget.com https://*.tradingview-widget.com`,
    `object-src 'none'`,
    `base-uri 'self'`,
    `form-action 'self'`,
